...
for i = 1:size(Time_Ranking,3)
    for j=1:24
    if isequal(linear(:,:,j),Time_Ranking(:,:,i))
        classTRUE(i,1)=j;
    end
    end
end
...
for i = 1:size(Time_Ranking,3)
    for j=1:24
    if isequal(linear(:,:,j),BernRangDelayed(:,:,i))
        classBR(i,1)=j;
    end
    end
end
for i = 1:size(Time_Ranking,3)
    for j=1:24
    if isequal(linear(:,:,j),countrevsolDelayed(:,:,i))
        classCRP(i,1)=j;
    end
    end
end
for i = 1:size(Time_Ranking,3)
    for j=1:24
    if isequal(linear(:,:,j),countsolDelayed(:,:,i))
        classCC(i,1)=j;
    end
    end
end
for i = 1:size(Time_Ranking,3)
    for j=1:24
    if isequal(linear(:,:,j),minswapssolDelayed(:,:,i))
        classMS(i,1)=j;
    end
    end
end
for i = 1:size(Time_Ranking,3)
    for j=1:24
    if isequal(linear(:,:,j),eigensolDelayed(:,:,i))
        classEIG(i,1)=j;
    end
    end
end
for i = 1:size(Time_Ranking,3)
    for j=1:24
    if isequal(linear(:,:,j),trcoreDelayed(:,:,i))
        classTC(i,1)=j;
    end
    end
end
...
tCRPBR_UI_WRI_01perc = prctile(idDiffCRP,0.1)
...
tCRPBR_UI_UI_01perc = prctile(idDiffCRP,0.1)
...
tCRPBR_Set_WRI_01perc = prctile(idDiffCRP,0.1)

tCRPBR_Set_WRI_95perc = prctile(idDiffCRP,95)
tCRPBR_Set_WRI_99perc = prctile(idDiffCRP,99)
tCRPBR_Set_WRI_999perc = prctile(idDiffCRP,99.9)

idDiffCRPCC = e1CC' - e1CRP';
idDiffCRPEIG = e1EIG' - e1CRP';

tCRPCC_Set_WRI_5perc = prctile(idDiffCRPCC,5)
tCRPCC_Set_WRI_1perc = prctile(idDiffCRPCC,1)
...
tCRPBR_Set_UI_01perc = prctile(idDiffCRP,0.1)
...
tCRPBR_EI_WRI_01perc = prctile(idDiffCRP,0.1)
...
tCRPBR_EI_UI_01perc = prctile(idDiffCRP,0.1)
